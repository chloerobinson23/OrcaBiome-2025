...
# Extract unique genera for each sample type
...
ggsave("FigS8_venn_diagram.jpeg", plot = plot1, dpi = 300, height = 12, width = 16, units = "in")
# NTC and PC removed
...
# grab just OB35, OB36, OB37, OB38, OB39
...
# Extract unique genera for each sample type
sample_type1_genera <- data %>%
  filter(SampleType == "OB07") %>%
  pull(Genus) %>%
  unique()

sample_type2_genera <- data %>%
  filter(SampleType == "OB05") %>%
  pull(Genus) %>%
  unique()
...
# Extract unique genera for each sample type
sample_type1_genera <- data %>%
  filter(SampleType == "OB09") %>%
  pull(Genus) %>%
  unique()

sample_type2_genera <- data %>%
  filter(SampleType == "OB08") %>%
  pull(Genus) %>%
  unique()
...
# Extract unique genera for each sample type
sample_type1_genera <- data %>%
  filter(SampleType == "OB12") %>%
  pull(Genus) %>%
  unique()

sample_type2_genera <- data %>%
  filter(SampleType == "OB11") %>%
  pull(Genus) %>%
  unique()
...
# Extract unique genera for each sample type
sample_type1_genera <- data %>%
  filter(SampleType == "OB14") %>%
  pull(Genus) %>%
  unique()

sample_type2_genera <- data %>%
  filter(SampleType == "OB13") %>%
  pull(Genus) %>%
  unique()
...
# Extract unique genera for each sample type
sample_type1_genera <- data %>%
  filter(SampleType == "OB19") %>%
  pull(Genus) %>%
  unique()

sample_type2_genera <- data %>%
  filter(SampleType == "OB18") %>%
  pull(Genus) %>%
  unique()
...
# Extract unique genera for each sample type
sample_type1_genera <- data %>%
  filter(SampleType == "OB22") %>%
  pull(Genus) %>%
  unique()

sample_type2_genera <- data %>%
  filter(SampleType == "OB21") %>%
  pull(Genus) %>%
  unique()
...
# Extract unique genera for each sample type
sample_type1_genera <- data %>%
  filter(SampleType == "OB27") %>%
  pull(Genus) %>%
  unique()

sample_type2_genera <- data %>%
  filter(SampleType == "OB26") %>%
  pull(Genus) %>%
  unique()
...
# Extract unique genera for each sample type
sample_type1_genera <- data %>%
  filter(SampleType == "OB30") %>%
  pull(Genus) %>%
  unique()

sample_type2_genera <- data %>%
  filter(SampleType == "OB29") %>%
  pull(Genus) %>%
  unique()
...
# Extract unique genera for each sample type
sample_type1_genera <- data %>%
  filter(SampleType == "OB24") %>%
  pull(Genus) %>%
  unique()

sample_type2_genera <- data %>%
  filter(SampleType == "OB23") %>%
  pull(Genus) %>%
  unique()

sample_type3_genera <- data %>%
  filter(SampleType == "OB25") %>%
  pull(Genus) %>%
  unique()
...
grid.draw(plot11)  # Draw the Venn diagram
...
# Extract unique genera for each sample type
sample_type1_genera <- data %>%
  filter(SampleType == "OB34") %>%
  pull(Genus) %>%
  unique()

sample_type2_genera <- data %>%
  filter(SampleType == "OB31") %>%
  pull(Genus) %>%
  unique()

sample_type3_genera <- data %>%
  filter(SampleType == "OB32") %>%
  pull(Genus) %>%
  unique()

sample_type4_genera <- data %>%
  filter(SampleType == "OB33") %>%
  pull(Genus) %>%
  unique()
...
grid.draw(plot12)  # Draw the Venn diagram
...
# Extract unique genera for each sample type
sample_type1_genera <- data %>%
  filter(SampleType == "OB39") %>%
  pull(Genus) %>%
  unique()

sample_type2_genera <- data %>%
  filter(SampleType == "OB35") %>%
  pull(Genus) %>%
  unique()

sample_type3_genera <- data %>%
  filter(SampleType == "OB37") %>%
  pull(Genus) %>%
  unique()

sample_type4_genera <- data %>%
  filter(SampleType == "OB38") %>%
  pull(Genus) %>%
  unique()
...
grid.draw(plot13)  # Draw the Venn diagram
...
# Extract unique genera for each sample type
sample_type1_genera <- data %>%
  filter(SampleType == "OB42") %>%
  pull(Genus) %>%
  unique()

sample_type2_genera <- data %>%
  filter(SampleType == "OB40") %>%
  pull(Genus) %>%
  unique()

sample_type3_genera <- data %>%
  filter(SampleType == "OB41") %>%
  pull(Genus) %>%
  unique()
...
grid.draw(plot14)  # Draw the Venn diagram
