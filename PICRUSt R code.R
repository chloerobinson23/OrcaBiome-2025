...
# 1. Load OTU table
# -------------------------
otu_table <- read_csv("otu_table.csv")  # first column = OTU_ID

# -------------------------
# 2. Load metadata
# -------------------------
metadata <- read_csv("metadata.csv")  # columns: SampleID, Environment

# -------------------------
# 3. Identify flukeprint and seawater samples
# -------------------------
...
# -------------------------
# 4. Determine OTUs unique to flukeprints
# -------------------------
...
# -------------------------
# 5. Filter OTU table to unique flukeprint OTUs and only flukeprint columns
# -------------------------
...
# -------------------------
# 6. Save filtered OTU table
# -------------------------
write_csv(otu_fluke_filtered, "otu_fluke_unique.csv")

# -------------------------
# 7. Filter sequences CSV to match unique OTUs
# -------------------------
...
# EC predictions
bac_ec <- read_tsv("//wsl.localhost/Ubuntu/home/cetusecologist/picrust2_inputs/picrust2_out/bac_EC_predicted.tsv.gz")

# KO predictions
bac_ko <- read_tsv("//wsl.localhost/Ubuntu/home/cetusecologist/picrust2_inputs/picrust2_out/bac_KO_predicted.tsv.gz")

# Pathways
pathways <- read_tsv("//wsl.localhost/Ubuntu/home/cetusecologist/picrust2_inputs/picrust2_out/pathways_out/path_abun_unstrat.tsv.gz")

# NSTI
bac_nsti <- read_tsv("//wsl.localhost/Ubuntu/home/cetusecologist/picrust2_inputs/picrust2_out/bac_marker_predicted_and_nsti.tsv.gz")
...
#p = 1.538e-05 < 0.05 → reject the null hypothesis
